...
4. Lastly, IMAGES! They gave me much grief. I learned that when inserting picture images into your html sheets, make sure you have them in the correct format (i.e. jpg or png) and have them in the orientation you want them to appear before importing them into your website. So, I leared this the hard way because many of my pictures appeared rotated or too big so I had to change the orientation by using the "rotate" command OR
Another part of inserting images within my website was having the right path (i.e.folder_name/image_name.jpg OR ![caption](image_name.jpg) [*note you don't need ""] to call that image when building your website. I had to make sure that all the pictures I wanted to use and show up in my website were inside my RMarkdown project folder and called properly. 
